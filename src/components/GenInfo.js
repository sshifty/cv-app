import React from 'react';
 ...
 const GenInfo =props=>{
        ...
        const {infos,fillAvatar,fillTitle,fillDescription,fillFullName,fillEmail,fillPhone,fillAddress}=props;
        return(
            <form  action="">
                ...
                <div className="input-div">
                    <input value={infos.email} onChange={fillEmail} type="email" name="email" id="email" maxLength="30" placeholder="email" required/>
                </div>                               
                <div className="input-div">
                    <input value={infos.phone} onChange={fillPhone} type="text" id="phone" pattern={phoneRegex.source} maxLength="30" placeholder="phone" required/>
                </div>
                <div className="input-div">
